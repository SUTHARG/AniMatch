...
class FirebaseService {
  ...
  Future<void> saveRecommendationMood(String uid, String mood) async {
    await _db.collection('users').doc(uid).set({
      'recommendationMood': mood,
    }, SetOptions(merge: true));
  }

  Stream<String?> recommendationMoodStream(String uid) {
    return _db.collection('users').doc(uid).snapshots().map(
          (doc) => doc.data()?['recommendationMood'] as String?,
        );
  }
